...
//https://github.com/pinknetworkx/atomicpacks-contract/blob/master/src/unboxing.cpp#L176
//https://github.com/pinknetworkx/atomicassets-contract/blob/master/include/atomicdata.hpp
...
namespace atomicassets {
    ...
    // [[eosio::on_notify("ATOMICASSETS_ACCOUNT::transfer")]] void receive_asset_transfer(
    //     name from,
    //     name to,
